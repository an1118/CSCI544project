...
class CONV(nn.Module):
    def __init__(self, task, model, input_size, output_size, num_channels, kernel_size, max_len, deformable=False, dynamic=False, use_embed=False, char_vocab=None, fix_length=True):
        ...
        # self.positional_encoding = CDILPositionalEncoding(input_size, max_len)
    ...
    def forward(self, x, mask=None):
        ...
        if DEBUG:
            print("x before positional encoding: ")
            print(x)
            print("x shape before positional encoding: ")
            print(x.shape)
...
# positional encoding
class CDILPositionalEncoding(nn.Module):
